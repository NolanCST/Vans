...
<body>
    <header>
        <nav class="navbar navbar-expand-lg p_bgGreen">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php">Vans</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="product.php">Enchères</a>
                        </li>
                        <li class="nav-item">
